  ...
  <h1>XAFS Standards at BMM</h1>'''
        ...
        for z in range(20, 95):
            ...
            ## generate a div for the table explaining each port
                if i == 0:
                    text = '        <div class="box box1">' + self.oneport(znum=z, name=el.name, symbol=el.symbol,
                                                                           material=this['material'],
                                                                           commonname=this['name'],
                                                                           location=location) + '        </div>\n'
                    #print(text, '\n')
                elif i == 1:
                    text = '        <div class="box box2">' + self.oneport(znum=z, name=el.name, symbol=el.symbol,
                                                                           material=this['material'],
                                                                           commonname=this['name'],
                                                                           location=location) + '        </div>\n'
                    #print(text, '\n')
                else:
                    text = '        <div class="box">' + self.oneport(znum=z, name=el.name, symbol=el.symbol,
                                                                      material=this['material'],
                                                                      commonname=this['name'],
                                                                      location=location) + '        </div>\n'
                    #print(text, '\n')
...
'''
    ...
    def oneport(self, znum=26, symbol='Fe', name='iron', material='FeTiO3', commonname='ilmenite', location='Fe'):
        ...
        form = '''
          <table>
            <tr>
              <td rowspan=2><span class="znum">{znum}</span></td>
              <td><span class="symbol">{symbol}&nbsp;&nbsp;&nbsp;&nbsp;{name}</span></td>
            </tr>
            <tr><td></td></tr>
            <tr>
